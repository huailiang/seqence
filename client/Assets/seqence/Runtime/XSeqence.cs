...
namespace UnityEngine.Timeline
{
    ...
    public class XSeqence
    {
        ...
        private GameObject seqenceRoot;
        ...
        {
            get { return editMode != SeqencePlayMode.EditorPause; }
        }
        ...
        public XSeqence(string path, PlayMode mode, Animator ator = null)
        {
            blending = false;
            ReadConf(path);
        ...
        public void Dispose(bool blend = false)
        {
            ...
            if (seqenceRoot && !blend)
            {
#if UNITY_EDITOR
                Object.DestroyImmediate(seqenceRoot);
#else
                Object.Destroy(seqenceRoot);
#endif
            }
            try
            {
        ...
        public void BindGo(GameObject go)
        {
            if (seqenceRoot != null)
            {
                go.transform.parent = seqenceRoot.transform;
            }
        }

        public static implicit operator bool(XSeqence seqence)
        {
            return seqence != null;
        }
    }
